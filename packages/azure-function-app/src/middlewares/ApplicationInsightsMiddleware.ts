...
import { ActionErrorEvent, ActionFinallyEvent, ActionInitializeEvent, Middleware } from '@bluish/core';
...
export class ApplicationInsightsMiddleware extends Middleware {
  ...
  public onInitialize(event: ActionInitializeEvent): void {
  ...
  public onFinally(event: ActionFinallyEvent): void | Promise<void> {
